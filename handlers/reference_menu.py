...
from keyboards.inline_buttoons import reference_menu_keyboard


async def reference_menu_call(call: types.CallbackQuery):
    await bot.send_message(
        chat_id=call.from_user.id,
        text=f'Hello {call.from_user.first_name}, glad to see you here',
...
def register_reference_menu_handlers(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(referral_list_call, lambda call: call.data == "reference_list")